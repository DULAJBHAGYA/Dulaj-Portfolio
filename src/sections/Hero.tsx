    ...
    <section id="home">
      <div className="py-32 md:py-38 lg:py-44 relative z-0 overflow-x-clip">
        ...
        <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
          ...
          {/* Orbit elements - stars */}
          <HeroOrbit size={800} rotation={-72} shouldOrbit orbitDuration="48s" shouldSpin spinDuration="6s">
            <StraIcon className="size-28 text-emerald-300" />
          </HeroOrbit>
          <HeroOrbit size={550} rotation={20} shouldOrbit orbitDuration="44s" shouldSpin spinDuration="6s">
            <StraIcon className="size-12 text-emerald-300"/>
          </HeroOrbit>
          <HeroOrbit size={590} rotation={98} shouldOrbit orbitDuration="46s" shouldSpin spinDuration="6s">
            <StraIcon className="size-8 text-emerald-300"/>
          </HeroOrbit>

          {/* Orbit elements - sparkles */}
          ...
          <HeroOrbit size={710} rotation={144} shouldOrbit orbitDuration="36s" shouldSpin spinDuration="3s">
        ...
        <div className="container relative z-10">
          ...
          <div className="max-w-lg mx-auto">
            ...
            <p className="mt-4 text-center text-white/60 md:text-lg">
              ...
              high-performing web & mobile applications. Let&apos;s discuss your next projects.
            </p>
          </div>
